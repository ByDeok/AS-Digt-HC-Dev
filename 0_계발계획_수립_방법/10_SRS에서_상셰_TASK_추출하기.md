...
| 4 | 인터페이스(API) 기준으로 분해 | Controller/Service/DTO |
| 5 | 데이터 모델을 스키마·Migration으로 변환 | DDL/Migration |
| 6 | NFR(성능/보안/운영)을 DevOps Task로 변환 | Load test, Security, Monitoring |

---

## 📘 **SRS → 개발 Task 추출의 핵심 원리 3가지**

### **1) SRS 요구사항 1개 = 개발 Task 여러 개**

SRS는 “테스트 가능하고 모호하지 않은 요구사항” 단위,

개발 Task는 “구현 단위(코드·설정·배포·문서화)”로 쪼개야 함.

> ex) REQ-FUNC-001 하나에서
      → Backend 여러개, Frontend 여러개, Infra 여러개 Task로 바뀌는 게 정상
> 

### **2) SRS의 구조(Functional / Non-Functional / Interface / Data)가 Task의 구조**
