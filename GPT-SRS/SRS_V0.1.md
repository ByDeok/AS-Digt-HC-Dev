...
- **CL-01: Mobile App (주요 클라이언트)**  
  - 시니어 및 보호자가 사용하는 모바일 애플리케이션(iOS/Android).  
...
| Story 4  | As a New user, I want to complete onboarding in under 3 minutes so that I can reach first value on day one.          | REQ-FUNC-001~006, 019; REQ-FUNC-003,004; REQ-NF-001,003,008,012 | TC-S4-01 ~ TC-S4-08          |
